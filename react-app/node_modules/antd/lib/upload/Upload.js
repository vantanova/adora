...
var InternalUpload = function InternalUpload(props, ref) {
  ...
  var onBatchStart = function onBatchStart(batchFileInfoList) {
    var _a; // Skip file which marked as `LIST_IGNORE`, these file will not add to file list
    ...
    var objectFileList = filteredFileInfoList.map(function (info) {
      return (0, _utils.wrapFile)(info.file);
    }); // Concat new files with prev files

    var newFileList = (0, _toConsumableArray2["default"])(mergedFileList);
    objectFileList.forEach(function (fileObj) {
      if (newFileList.every(function (existFile) {
        return existFile.uid !== fileObj.uid;
      })) {
        newFileList.push(fileObj);
      }
    });
    onInternalChange((_a = filteredFileInfoList[0]) === null || _a === void 0 ? void 0 : _a.file, newFileList);
  };

  var onStart = function onStart(file) {
    var targetItem = (0, _utils.wrapFile)(file);
    targetItem.status = 'uploading';
    var nextFileList = (0, _toConsumableArray2["default"])(mergedFileList);
  ...
  var onSuccess = function onSuccess(response, file, xhr) {
    ...
    var targetItem = (0, _utils.getFileItem)(file, mergedFileList); // removed
    ...
    targetItem.xhr = xhr;
    onInternalChange((0, _utils.wrapFile)(targetItem), (0, _toConsumableArray2["default"])(mergedFileList));
  };
  ...
  var onProgress = function onProgress(e, file) {
    ...
    onInternalChange((0, _utils.wrapFile)(targetItem), (0, _toConsumableArray2["default"])(mergedFileList), e);
  };
  ...
  var handleRemove = function handleRemove(file) {
    ...
    Promise.resolve(typeof onRemove === 'function' ? onRemove(file) : onRemove).then(function (ret) {
      ...
      if (removedFileList) {
        currentFile = (0, _utils.wrapFile)(file);
